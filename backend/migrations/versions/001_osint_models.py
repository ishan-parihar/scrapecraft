...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('collection_requirements', postgresql.ARRAY(sa.String()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('assigned_targets', postgresql.ARRAY(sa.String()), nullable=True),
        sa.Column('current_task', postgresql.JSONB(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('targets', postgresql.ARRAY(sa.String()), nullable=True),
